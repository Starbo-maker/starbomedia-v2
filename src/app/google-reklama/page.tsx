                    ...
                    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                        <details className={styles.faqItem}>
                            ...
                            <p className={styles.faqAnswer}>
                                ...
                                zvyčajne začínajú na 300–500 € mesačne, väčšie projekty sa pohybujú v tisícoch. Presný odhad dostanete po vstupnom audite účtu.
                            </p>
                        </details>
                        <details className={styles.faqItem}>
