                    ...
                    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                        <details className={styles.faqItem}>
                            ...
                            <p className={styles.faqAnswer}>
                                ...
                                zvyčajne začínajú na 300–500 € mesačne, väčšie projekty sa pohybujú v tisícoch. Reálne čísla z 23 miliónov €
                                preinvestovaných v našich účtoch – CPC, sezónnosť aj cenník správy – nájdete v článku{' '}
                                <Link href="/kolko-stoji-google-ads-reklama-na-slovensku-2026">Koľko stojí Google Ads reklama na Slovensku</Link>.
                                Presný odhad dostanete po vstupnom audite účtu.
                            </p>
                        </details>
                        <details className={styles.faqItem}>
