...
export const metadata = {
    title: 'Senior PPC špecialista (Šaľa) | Kariéra | Starbomedia',
    description: 'Hľadáme ambiciózneho Senior PPC špecialistu do nášho tímu. Google Ads, Meta Ads, GA4, Looker Studio. Projekty na Slovensku aj v zahraničí.',
};

export default function PpcSpecialistaPage() {
    const html = readFileSync(path.join(process.cwd(), 'src/content/kariera-ppc-specialista.html'), 'utf8');
        ...
        <>
            <header className={serviceStyles.header} style={{ padding: '6rem 0 2rem' }}>
                <div className={`container ${serviceStyles.headerContent}`}>
                    ...
                    <h1 className={serviceStyles.title} style={{ fontSize: '2.5rem' }}>Senior PPC špecialista</h1>
                </div>
            </header>
