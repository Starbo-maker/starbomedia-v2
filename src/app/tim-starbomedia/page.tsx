...
const TEAM: { name: string; role: string; photo?: string }[] = [
    ...
    { name: 'Monika Alaxinová', role: 'Online marketing konzultant', photo: '/team/monika-alaxinova.webp' },
    { name: 'Marek Hollý', role: 'Online marketing konzultant', photo: '/team/marek-holly.webp' },
